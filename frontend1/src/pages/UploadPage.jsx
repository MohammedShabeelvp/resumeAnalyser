    ...
    <div className="page-container flex justify-center py-16">
      <div className="w-full" style={{ maxWidth: "28rem" }}>
          ...
          >
            ...
            {file ? (
              <>
                ...
                <p className="text-xs text-[var(--color-muted)]">{(file.size / 1024).toFixed(0)} KB</p>
              </>
            ) : (
              <>
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" className="mb-3 text-[var(--color-muted)]">
                  <path
                ...
                <p className="text-xs text-[var(--color-muted)]">PDF only</p>
              </>
            )}
          </label>
        ...
        <div className="mt-6 text-center">
          <Link to="/history" className="text-sm text-[var(--color-teal)] hover:underline">
            View past analyses →
          </Link>
        </div>
      </div>
